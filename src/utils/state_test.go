...
func TestNodeState_String(t *testing.T) {
	nodeState := utils.NodeState{
		NodeName: "Node1",
		Balance:  100,
		SentMsgs: map[string]utils.AppMessage{
			"Node2": {Msg: utils.Message{ID: "msg1"}, IsMarker: false, From: 1, To: 2},
			"Node3": {Msg: utils.Message{ID: "msg2"}, IsMarker: false, From: 1, To: 3},
		},
